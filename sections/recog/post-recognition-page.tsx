    ...
    <RecogLayout dataActivity="postRecognition">
      <div className="flex w-full flex-col gap-6 px-20">
        <div className={cn(demoWideContentClassName, "relative px-0 py-2 sm:py-3 md:py-4")}>
          <div className="grid w-full grid-cols-1 gap-10 text-black lg:grid-cols-2 lg:items-stretch lg:gap-8 xl:gap-12">
            <div className="flex min-h-[min(52vh,420px)] w-full min-w-0 flex-col gap-4 self-stretch sm:gap-5 lg:min-h-0 lg:h-full px-10">
              <div className="flex min-w-0 flex-col items-start gap-4 sm:gap-5">
                <h2 className="text-left text-xl font-bold leading-snug sm:text-2xl">Let&apos;s look at some definitions and examples</h2>
              ...
              {allCardsSeenBackOnce ? (
                <div className="flex w-full max-w-lg flex-col gap-3 text-black pt-4">
                  <h3 className="text-left text-lg font-bold leading-snug sm:text-xl">These are activities you may already use.</h3>
            ...
            <div className="flex w-full min-w-0 flex-col justify-center lg:items-stretch">
              <div className="flex w-full max-w-[620px] flex-1 flex-col items-center justify-center rounded-2xl border border-black/10 bg-white/30 p-4 sm:p-6 lg:min-h-0 lg:self-center">
                <QuadrantAxesModel
