  ...
  return (
    <RecogLayout dataActivity="recognition-categories">
      <div className="flex w-full min-w-0 flex-col px-4 py-8 sm:px-6 sm:py-10 lg:px-10 lg:py-12">
        <div className="mx-auto grid h-full min-h-[min(620px)] min-w-0 w-full max-w-6xl grid-cols-1 gap-6 text-black sm:gap-8 lg:grid-cols-2 lg:items-stretch lg:gap-6 xl:gap-8">
          ...
          <div className="relative flex items-center justify-center h-full min-h-[min(620px)] w-full min-w-0 overflow-hidden rounded-xl bg-black/4">
            <iframe
              title="TikTok video"
              className="min-h-[min(620px)] w-full border-0"
